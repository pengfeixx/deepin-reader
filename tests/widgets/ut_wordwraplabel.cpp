...
TEST_F(UT_WordWrapLabel, setText_test_001)
{
    m_tester->setText("123");
    EXPECT_TRUE(m_tester->m_text == "123");
}

TEST_F(UT_WordWrapLabel, setMargin_test_001)
{
    m_tester->setMargin(1);
    EXPECT_TRUE(m_tester->m_margin == 1);
}

TEST_F(UT_WordWrapLabel, paintEvent_test_001)
{
...
TEST_F(UT_WordWrapLabel, adjustContent_test_001)
{
...
TEST_F(UT_WordWrapLabel, WordWrapLabel_test_001)
{
    SUCCEED();
}
